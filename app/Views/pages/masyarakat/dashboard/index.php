...
<div class="w-full px-6 py-6 mx-auto">
    ...
    <h3 class="text-center text-white mt-2 mb-16!">Selamat Datang <span class="underline"><?= $user['name'] ?></span></h3>
                ...
                <div class="pb-4 overflow-x-auto">
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500 px-6">
                        <thead class="align-bottom">
                            <tr>
                                <?php foreach (['jenis Surat', 'keperluan', 'Tanggal Pengajuan', 'Tanggal Selesai', 'status'] as $tabTitle) : ?>
                        ...
                        <tbody>
                            <?php foreach ($pengajuanSurat as $index => $pengajuan): ?>
                                <tr>
                                    ...
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <p class="mb-0 font-semibold leading-tight text-xs"><?= substr($pengajuan['keperluan'], 0, 35) . '...' ?></p>
                                    </td>
                                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
